...
const Checkout = () => {
    ...
    return (
        <>
            {/* <div classNameName="min-w-screen min-h-screen bg-gray-200 flex items-center justify-center px-5 pb-10 pt-16">
                <div classNameName="w-full mx-auto rounded-lg bg-white shadow-lg p-5 text-gray-700" style="max-width: 600px">
                     */}
        ...
        <div className="mb-3 flex -mx-2">
            ...
            <div className="px-2">
                <label for="type2" className="flex items-center cursor-pointer">
                    ...
                    <div>
                        <button type='submit' className="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold" onSubmit={() => alert("Order Placed")}><i classNameName="mdi mdi-lock-outline mr-1"></i>PAY NOW <span className='text-black'>${tot+2.5}</span></button>
                    </div>
                {/* </div>
            </div> */}
            </form>
